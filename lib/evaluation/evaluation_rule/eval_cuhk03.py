...
class EvalCUHK03(EvaluatorBase):
    def _get_cmc_mAP(self, distMat):
        cmc, mAP = eval_cuhk03(distMat, self.probe_id, self.gallery_id, self.probe_cam_id, self.gallery_cam_id, max_rank=20, logger=self.logger)
        return cmc, mAP